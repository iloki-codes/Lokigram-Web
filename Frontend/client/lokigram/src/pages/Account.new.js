...
//                 <div className="">It's quick and easy.</div>
                
//                 <div>

//                     <form className="" onsubmit={Signup}>
                    
//                         <input type="text" name="name" id="password" aria-required="true" placeholder="FirstName" />
//                         <input type="text" name="surname" id="surname" aria-required="true" placeholder="Surname" />
//                         <input type="email" name="email" id="email" aria-required="true" placeholder="Email Address" />
//                         <input type="password" name="password" id="password" aria-required="true" placeholder="New Password" />

//                         <div className="">Date Of Birth
                
//                         <select aria-label="birthdate" name="date" id="date" className="">
...
//                             <option value="29">29</option><option value="30">30</option><option value="31" selected="1">31</option>
               
//                         </select>

//                         <select aria-label="birthdaymonth" name="month" id="month" className="">
               
//                             <option value="1">Jan</option><option value="2">Feb</option><option value="3">Mar</option><option value="4">Apr</option><option value="5">May</option><option value="6">Jun</option><option value="7" selected="1">Jul</option><option value="8">Aug</option><option value="9">Sep</option><option value="10">Oct</option><option value="11">Nov</option><option value="12">Dec</option>
                        
//                         </select>

//                         <select aria-label="birthdayyear" name="year" id="year" className="">
...
//                                 <input type="radio" className="" name="sex" value="female" id="female" />
//                             </span>
//                             <span className="">
//                                 <label className="" for="">Male</label>
//                                 <input type="radio" className="" name="sex" value="male" id="male" />
//                             </span>
//                             <span className="">
//                                 <label className="" for="">Other</label>
//                                 <input type="radio" className="" name="sex" value="other" id="other" />
//                             </span>
//                         </div>
