...
import { postDataAPI, patchDataAPI, deleteDataAPI } from '../../utils/fetchData.js';
import { createNotify, removeNotify } from '../actions/notifyAction.js';
...
export const createComment = ({post, newComment, auth, socket}) => async (dispatch) => {
    ...
    try {
        ...
        const msg = {
            ...
            recipients: newComment?.reply && newComment?.tag ? [newComment?.tag?._id] : [post?.user?._id],
            url: `/post/${post._id}`,
